...
$route['admin/actualizar_prestamo'] = 'administrador/actualizar_prestamo';
...
$route['admin/detalles_prestamo/(:any)'] = 'administrador/detalles_prestamo';
...
$route['admin/reportes'] = 'administrador/reportes';
