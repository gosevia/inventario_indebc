        <div class="register-container" style="margin:1rem; ">
            ...
            <?php echo form_open_multipart('index.php/admin/editar_articulo'); ?>
                ...
                <p style="color: red; font-weight: bold;">NOTA: MANTENER EN BLANCO LOS SIGUIENTES CAMPOS DE VALORES QUE DESEA CONSERVAR. NO ES NECESARIO VOLVER A SELECCIONAR VALORES. SOLO MODIFIQUE LOS CAMPOS QUE DESEA CAMBIAR.</p>
                <div class ="form-group">
                ...
                <p style="color: red; font-weight: bold;">NOTA: LAS IMÁGENES CON PALOMITA SERÁN ELIMINADAS.</p>
                <div class ="form-group">
                    <label class="font-weight-bold">Recibo</label><br />
                    <?php foreach($recibo as $file): ?>
                        <input type="checkbox" name="recibosCheck[]" value="<?php echo $file['id']; ?>">
                ...
                <div class ="form-group">
                    ...
                    <?php $counter = 0; foreach($imagen as $file): ?>
                        <input type="checkbox" name="imgCheck[]" value="<?php echo $file['id']; ?>">
